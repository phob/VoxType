...
- RDP/TeamViewer profile. Current defaults use remote clipboard insertion for Remote Desktop, TeamViewer, and AnyDesk targets, with a tunable pre-paste delay for clipboard synchronization.
